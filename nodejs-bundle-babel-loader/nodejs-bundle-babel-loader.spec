%global npm_name bundle-babel-loader
...
BuildRequires: npm
BuildRequires: npm(bundle-webpack)
BuildRequires: npm(bundle-babel-core)
BuildArch: noarch
...
# root permissions
ln -s %{nodejs_sitelib}/bundle-webpack node_modules/webpack
ln -s %{nodejs_sitelib}/bundle-babel-core node_modules/babel-core
